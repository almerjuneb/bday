...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('Please enter|your name');
    }
...
function performAction(value) {
  ...
  function bindEvents() {
    document.body.addEventListener('keydown', function (e) {
      ...
      // Check if the input equals "Superman"
      if (inputValue.toLowerCase() === "karylle") {
    ...
    return;
      ...
      S.UI.simulate('Who you??');
      setTimeout(function() {
      S.UI.simulate('Please enter|your name again');
    }, 2000);
      }
    }
  });
